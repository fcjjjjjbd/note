...
<template>
  <view class="">
    ...
    下载源码本地npm install 提交 git init 初始化仓库 重置本地git仓库 
git add .
    第一次新增需要写 以后不用写 git commit -m '提交信息' 提交本地仓库 
    git remote add origin https://gitee.com/yaya1212/git 连接云端 push origin master git
