...
<template>
  <view class="self">
    ui(写1个想1个,设计0全错误),htmlcss,js,unicloud,手机测试,上线,推广,挣钱,用户反馈评论
    学习:bli,youtube,张天禹,咸虾米,前端三木,现用现学
    工具:远程向日葵,clash,油猴greasy(js脚本),desktop(git图形),小米传输文件,apipost,bandizip,cursorAI
    前端组件库:uni组件, tdesign; yt-dlp下载视频
    快捷键
    ctrlb隐藏显示目录
